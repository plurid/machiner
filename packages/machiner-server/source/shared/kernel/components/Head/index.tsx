...
const Head: React.FC<HeadProperties> = (
    ...
    const titleValue = title || `joiner`;
    const descriptionValue = description || 'Multi/Mono-Repository Task Runner';
    const ogTitleValue = ogTitle || title || `joiner`;
    const ogDescriptionValue = ogDescription || description || 'Multi/Mono-Repository Task Runner';
